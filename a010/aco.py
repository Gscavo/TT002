"""
    Biblioteca baixada na internet.
    Porém, foi necessária a alteração de uma parte da implementação,
    portanto estamos enviando a biblioteca alterada.

    Link do projeto original: https://pypi.org/project/aco/
"""
import math
import random
